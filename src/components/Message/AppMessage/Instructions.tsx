...
const ApiKeyInstructionsText = `## Getting Started with CardioCheck

Welcome to CardioCheck , your open-source web companion for coding with Large Language Models (LLMs). Designed with health patients in mind, Cardio Check transforms the way you interact with GPT models, making it effortless to read, write, and analyze your health history.

We think CardioCheck is the best platform for analysis your health and getting all queries answered. Here's a few of the reasons why we think you'll agree comapred to our competatior:

| Feature                               | CardioCheck | HealthPlus | Med-GPT |
| ------------------------------------- |:---------:|:-------:|:-------:|
| BMI Index | ✅        | ❌      | ❌      |
| Age | ✅         |❌       | ❌      |
| HyperTesnion  | ✅        | ❌      | ❌      |
...
You can begin using CardioCheck today by following these steps:
...
3. Enter an **API Key**. CardioCheck is a _"bring your own API Key"_ web app. No matter which provider you choose, CardioCheck needs an API Key to start making API calls on your behalf. API Keys are never shared, and get stored in your browser's local storage.
